		...
		?>
			...
			<?php } ?>
				...
				<?php if( $cat_layout == 'style-4' ): ?>
					<div class="penci-single-mag-slider penci-owl-carousel penci-owl-carousel-slider" data-auto="<?php echo $catslider_autoplay; ?>" data-dots="true" data-nav="false">
				<?php endif; ?>
				...
				?>
					<div class="penci-magcat-carousel-wrapper">
						<div class="penci-owl-carousel penci-owl-carousel-slider penci-magcat-carousel" data-auto="<?php echo $catslider_autoplay; ?>" data-speed="400" data-item="<?php echo $data_item; ?>" data-desktop="<?php echo $data_item; ?>" data-tablet="2" data-tabsmall="1">
				<?php endif; ?>
