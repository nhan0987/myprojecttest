...
if( ! class_exists( 'penci_latest_tweets_widget' ) ) {
	class penci_latest_tweets_widget extends WP_Widget {
							...
							<div class="penci-tweet">
								...
								<div class="tweet-intents">
									<div class="tweet-intents-inner">
										<span><a target="_blank" rel="noopener" class="reply" href="https://twitter.com/intent/tweet?in_reply_to=<?php echo sanitize_text_field( $tweet_id ); ?>"><?php echo do_shortcode( $reply ); ?></a></span>
										<span><a target="_blank" rel="noopener" class="retweet" href="https://twitter.com/intent/retweet?tweet_id=<?php echo sanitize_text_field( $tweet_id ); ?>"><?php echo do_shortcode( $retweet ); ?></a></span>
										<span><a target="_blank" rel="noopener" class="favorite" href="https://twitter.com/intent/favorite?tweet_id=<?php echo sanitize_text_field( $tweet_id ); ?>"><?php echo do_shortcode( $favorite ); ?></a></span>
									</div>
								</div>
							</div>
						<?php endforeach; ?>
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['reply']    = $new_instance['reply'];
			$instance['retweet']  = $new_instance['retweet'];
			$instance['favorite'] = $new_instance['favorite'];
