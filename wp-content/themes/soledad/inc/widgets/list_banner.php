...
if( ! class_exists( 'penci_list_bannner_widget' ) ) {
	class penci_list_bannner_widget extends WP_Widget {
		...
		function __construct() {
			/* Widget settings. */
			$widget_ops = array( 'classname'   => 'penci_list_imgs_widget', 'description' => esc_html__( 'A widget helps you display a banner or multi-banners on your sidebar. You also can use this widget to display your featured categories/posts/pages.. Everything is custom', 'soledad' ) );
			...
			if( 4.3 > $wp_version ) {
				...
				parent::__construct( 'penci_list_bannner_widget', esc_html__( '.Soledad List Banners', 'soledad' ), $widget_ops, $control_ops );
			}
		}
			...
			?>
				<?php if( $img1 || $img2 || $img3 ): ?>
					...
					<?php if ( $img1 ) : /* Banner 1 */  ?>
						...
						<div class="penci-promo-item penci-lazy<?php if( $text1 ): echo ' penci-banner-has-text'; endif; /* Crop */  if( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if( $crop && ! $height ){ echo ' data-src="'. do_shortcode( $img1 ) .'"'; } elseif( $crop && $height	){ echo ' data-src="'. do_shortcode( $img1 ) .'" style="height:'. $height .'px;"'; } ?>>
						<?php } else { ?>
						...
						<?php }?>
							<?php if( $url1 ): ?>
								<a class="penci-promo-url" aria-label="<?php if( $text1 ){ echo $text1; } else { echo 'Banner1'; } ?>" href="<?php echo do_shortcode( $url1 ); ?>"<?php echo sanitize_text_field( $target ); ?>></a>
							<?php endif; ?>
							<?php if( ! $crop ): ?>
							<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
					...
					<?php if ( $img2 ) : /* Banner 2 */  ?>
						<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
						<div class="penci-promo-item penci-lazy<?php if( $text2 ): echo ' penci-banner-has-text'; endif; /* Crop */  if( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if( $crop && ! $height ){ echo ' data-src="'. do_shortcode( $img2 ) .'"'; } elseif( $crop && $height	){ echo ' data-src="'. do_shortcode( $img2 ) .'" style="height:'. $height .'px;"'; } ?>>
						<?php } else { ?>
						...
						<?php }?>
							<?php if( $url2 ): ?>
								<a class="penci-promo-url" aria-label="<?php if( $text2 ){ echo $text2; } else { echo 'Banner2'; } ?>" href="<?php echo do_shortcode( $url2 ); ?>"<?php echo sanitize_text_field( $target ); ?>></a>
							<?php endif; ?>
							<?php if( ! $crop ): ?>
								<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
					...
					<?php if ( $img3 ) : /* Banner 3 */  ?>
						<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
						<div class="penci-promo-item penci-lazy<?php if( $text3 ): echo ' penci-banner-has-text'; endif; /* Crop */  if( $crop && ! $height ): echo ' penci-banner-crop'; endif; ?>"<?php if( $crop && ! $height ){ echo ' data-src="'. do_shortcode( $img3 ) .'"'; } elseif( $crop && $height	){ echo ' data-src="'. do_shortcode( $img3 ) .'" style="height:'. $height .'px;"'; } ?>>
						<?php } else { ?>
						...
						<?php }?>
							<?php if( $url3 ): ?>
								<a class="penci-promo-url" aria-label="<?php if( $text3 ){ echo $text3; } else { echo 'Banner'; } ?>" href="<?php echo do_shortcode( $url3 ); ?>"<?php echo sanitize_text_field( $target ); ?>></a>
							<?php endif; ?>
							<?php if( ! $crop ): ?>
								<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
