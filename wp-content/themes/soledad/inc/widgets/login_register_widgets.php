...
if( ! class_exists( 'Penci_Login_Register_Widget' ) ) {
	class Penci_Login_Register_Widget extends WP_Widget {
		...
		function __construct() {
			/* Widget settings. */
			$widget_ops = array( 'classname'   => 'penci_login_register_widget', 'description' => esc_html__( 'A widget that displays a login or register widget', 'soledad' ) );
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['form_style'] = $new_instance['form_style'];
