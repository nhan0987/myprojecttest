...
<?php if ( $feat_query->have_posts() ) : ?>
	<div class="item">
		<div class="wrapper-item wrapper-item-classess">
			...
			$thumb = $image_size;
			if( ( $i%5 == 4 || $i%5 == 0 ) && ! penci_is_mobile() ): $thumb = $image_size_big; endif;
			?>
			<div class="penci-item-mag penci-item-<?php echo ( $i%5 ); ?>">
				<?php if( ! get_theme_mod( 'penci_disable_lazyload_slider' ) ) { ?>
					<a class="penci-image-holder <?php echo penci_classes_slider_lazy(); ?>" data-src="<?php echo penci_get_featured_image_size( get_the_ID(), $thumb ); ?>" href="<?php the_permalink(); ?>" title="<?php echo wp_strip_all_tags( get_the_title() ); ?>"></a>
				<?php } else { ?>
				...
				<div class="penci-slide-overlay penci-slider6-overlay">
					<a class="overlay-link" aria-label="<?php echo wp_trim_words( wp_strip_all_tags( get_the_title() ), 6, '...' ); ?>" href="<?php the_permalink(); ?>"></a>
