	...
	function penci_category_fields_meta( $tag ) {
		...
		<tr class="form-field">
			...
			<td>
				...
				<p class="description">This option will override with the general layout you selected on General > General Settings > Category, Tags, Search, Archive Pages > Category, Tag, Search, Archive Layout</p>
			</td>
		</tr>
		<tr class="form-field">
			<th scope="row" valign="top">
		...
		<tr class="form-field">
			...
			<td>
				...
				<p class="description">Use it to change the featured layout for this category when you use this layout as a featured category. Check more on <a href="https://www.youtube.com/watch?v=gnbMyMBCK_M&list=PL1PBMejQ2VTwp9ppl8lTQ9Tq7I3FJTT04" target="_blank">this video tutorial</a></p>
			</td>
		</tr>
		<tr class="form-field">
			<th scope="row" valign="top">
