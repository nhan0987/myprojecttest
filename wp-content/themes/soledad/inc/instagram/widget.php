		...
		function form( $instance ) {
			...
			<div class="penci-instagram-container">
				<p>
					...
					<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance_title; ?>"/>
				</p>
				...
				<p class="<?php if ( 'username' != $instance['search_for'] ) {echo 'hidden';} ?>">
					...
					<span class="penci-description">Please fill the Instagram Access Token here. You can get Instagram Access Token via <a href="https://pencidesign.net/penci_instagram/" target="_blank">https://pencidesign.net/penci_instagram</a></span>
				</p>
				<p class="<?php if ( 'username' != $instance['search_for'] ) {echo 'hidden';} ?>">
					...
					<span class="penci-description">Please enter the User ID for this Profile ( Eg: 123456789987654321 )  You can get User ID via <a href="https://pencidesign.net/penci_instagram/" target="_blank">https://pencidesign.net/penci_instagram/</a></span>
				</p>
