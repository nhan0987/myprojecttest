...
class Penci_Soledad_Dashboard {
	...
	function load_files(){
		if( is_admin() && ! function_exists( 'rwmb_check_php_version' ) ) {
	...
	public function add_menu() {
		...
		add_menu_page( $wel_page_title, $wel_page_title_html, 'manage_options', 'soledad_dashboard_welcome', array( $this, 'dashboard_welcome' ), null, 3 );
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_script( "soledad-dashboard-script", get_template_directory_uri() . '/inc/dashboard/js/script.js?v=7.9', array( 'jquery' ) );
