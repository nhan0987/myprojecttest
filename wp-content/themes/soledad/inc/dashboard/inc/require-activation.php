...
if( ! function_exists( 'penci_soledad_is_activated' ) ){
	function penci_soledad_is_activated(){
		return get_option( strrev( 'detavitca_si_dadelos_icnep' ) );
	}
}
	...
	class Penci_Require_Active{
		...
		function validation_notice() {
			...
			<div class="notice notice-success is-dismissible" style="display:none;">
				<p>
					<a class="penci-notice-logo" href="<?php echo esc_url( 'https://pencidesign.net/' ); ?>" target="_blank"><?php $this->get_icon_penci(); ?></a>
					...
					<div class="penci-activate-envato-code">
						...
						<form id="penci-check-license" action="<?php echo admin_url( 'admin.php?page=soledad_active_theme' ); ?>">
							<div class="penci-activate-inputs">
								<input name="evato-code" class="penci-form-control evato-code" type="text" placeholder="<?php esc_html_e( 'Your Purchase Code', 'soledad' ); ?>" value="" autocomplete="off">
						...
						<div class="penci-activate-extra-notes">
							...
							<p class="penci-activate-desc" style="margin-bottom: 0;"><?php _e( 'The data is stored in a server located in US, and we do not share any of this information with third-party partners.' ); ?></p>
							</p>
						</div>
					</div>
				</div>
		...
		public function theme_license_page(){
			...
			<div class="wrap about-wrap penci-about-wrap penci-active-theme penci-dashboard-wapper">
				...
				<h2 class="nav-tab-wrapper">
					...
					<a href="<?php echo admin_url( 'customize.php' ) ?>" class="nav-tab"><?php esc_html_e( 'Customize Style', 'soledad' ); ?></a>
					<a href="<?php echo admin_url( 'admin.php?page=soledad_custom_fonts' ) ?>" class="nav-tab"><?php esc_html_e( 'Custom Fonts', 'soledad' ); ?></a>
					<a href="<?php echo admin_url( 'admin.php?page=soledad_theme_license' ) ?>" class="nav-tab nav-tab-active"><?php esc_html_e( 'Theme License', 'soledad' ); ?></a>
				</h2>
				<div class="penci-activate-wrap gt-tab-pane gt-is-active">
					<div class="penci-activate-envato-code">
						<div class="penci-activate-code-title"><?php esc_html_e( 'Theme License', 'soledad' ); ?></div>
						<?php $license_data = get_option( strrev('atad_desahcrup_dadelos_icnep') ); 
						if( ! empty( $license_data ) ){
						?>
						...
						<p class="penci-license-detail-desc" style="font-size: 15px;">
							...
							?>
							<strong style="display: inline-block; margin-bottom: 8px; min-width: 140px;"><?php esc_html_e( 'Buyer Username', 'soledad' ); ?></strong> : &nbsp;&nbsp;<strong><?php echo $buyer_display; ?></strong><br>
							<?php } ?>
							<?php if( isset( $license_data['bount_time'] ) && $license_data['bount_time'] ){ ?>
							<strong style="display: inline-block; margin-bottom: 8px; min-width: 140px;"><?php esc_html_e( 'Purchase Date', 'soledad' ); ?></strong> : &nbsp;&nbsp;<strong><?php echo $license_data['bount_time']; ?></strong><br>
							<?php } ?>
							...
							?>
							<strong style="display: inline-block; margin-bottom: 8px; min-width: 140px;"><?php esc_html_e( 'Item Purchase Code', 'soledad' ); ?></strong> : &nbsp;&nbsp;<strong><?php echo $code_display; ?></strong><br>
							<?php } ?>
						</p>
		...
		public function new_update_page(){
			...
			<div class="wrap about-wrap penci-about-wrap penci-active-theme penci-dashboard-wapper">
				...
				<h2 class="nav-tab-wrapper">
					...
					<a href="<?php echo admin_url( 'admin.php?page=soledad_new_update' ) ?>" class="nav-tab nav-tab-active"><?php esc_html_e( 'New Update', 'soledad' ); ?></a>
				</h2>
				<div class="penci-activate-wrap gt-tab-pane gt-is-active">
					<div class="penci-activate-envato-code">
						<div class="penci-activate-code-title"><?php esc_html_e( 'Update Soledad Theme', 'soledad' ); ?></div>
						<p class="penci-license-detail-desc">
						<?php esc_html_e( 'A new version of Soledad theme just released - Soledad Theme version ', 'soledad' ); ?><?php echo $new_version; ?><br>
