...
class PenciRecentPosts extends Base_Widget {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'ordernum', array(
				'label' => __( 'Show the order number?', 'soledad' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		...
		$this->add_control(
			'showborder', array(
				'label' => __( 'Hide Border Bottom?', 'soledad' ),
				'type'  => Controls_Manager::SWITCHER,
				'selectors'          => array(
							...
							<div class="side-item">
								...
								<div class="side-item-text">
									...
									<div class="grid-post-box-meta penci-side-item-meta">
										<?php if ( $showauthor ): ?>
											<span class="side-item-meta side-wauthor"><?php echo penci_get_setting('penci_trans_by'); ?> <a class="url fn n" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a></span>
										<?php endif; ?>
										<?php if ( ! $postdate ): ?>
											<span class="side-item-meta side-wdate"><?php penci_soledad_time_link(); ?></span>
										<?php endif; ?>
										<?php if ( $showcomment ): ?>
											<span class="side-item-meta side-wcomments"><a href="<?php comments_link(); ?> "><?php comments_number( '0 ' . penci_get_setting( 'penci_trans_comment' ), '1 '. penci_get_setting( 'penci_trans_comment' ), '% ' . penci_get_setting( 'penci_trans_comments' ) ); ?></a></span>
										<?php endif; ?>
										<?php if ( $showviews ): ?>
