	...
	protected function _register_controls() {
		...
		$this->add_control(
			'headline_upper', array(
				...
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => array( '{{WRAPPER}} .headline-title' => 'text-transform: none; letter-spacing: 0;' ),
			)
		);
		...
		$this->add_control(
			'titles_upper', array(
				...
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => array( '{{WRAPPER}} a.penci-topbar-post-title' => 'text-transform: none; letter-spacing: 0;' ),
			)
		);
