...
class Module extends Module_Base {
	...
	public static function add_exclude_controls( $widget ) {
		...
		$widget->add_control(
			'exclude_ids', array(
				...
				'multiple'    => true,
				'filter_type' => 'by_id',
				'condition'   => array( 'exclude' => 'manual_selection' )
			)
		);
	}
	...
	public function register_ajax_actions( $ajax_manager ) {
		...
		$ajax_manager->register_ajax_action( 'penci_panel_posts_control_filter_autocomplete', array( $this, 'ajax_posts_filter_autocomplete' ) );
	}
