	...
	<article id="post-<?php the_ID(); ?>" class="item hentry">
		...
		<?php if ( has_post_thumbnail() ) : ?>
			<div class="thumbnail thumb-left">
				...
				<a class="penci-image-holder penci-lazy<?php echo penci_class_lightbox_enable(); ?>" data-src="<?php echo penci_get_featured_image_size( get_the_ID(), penci_featured_images_size_vcel( 'large' , $penci_featimg_size, $thumb_bigsize ) ); ?>" href="<?php penci_permalink_fix(); ?>" title="<?php echo
				wp_strip_all_tags(
					get_the_title() ); ?>">
				</a>
				<?php } else { ?>
				<a class="penci-image-holder<?php echo penci_class_lightbox_enable(); ?>" style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), penci_featured_images_size_vcel('large' , $penci_featimg_size, $thumb_bigsize ) ); ?>');" href="<?php penci_permalink_fix(); ?>" title="<?php
		...
		<div class="mixed-detail">
			<div class="grid-header-box">
				...
				<?php if ( 'yes' != $grid_date || 'yes' != $grid_author || 'yes' == $grid_viewscount || penci_isshow_reading_time( $grid_readtime ) ) : ?>
		...
		<?php if ( has_post_thumbnail() ) : ?>
			<div class="thumbnail thumb-right">
				...
				?>
				<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
					<a class="penci-image-holder penci-lazy<?php echo penci_class_lightbox_enable(); ?>" data-src="<?php echo penci_get_featured_image_size( get_the_ID(), penci_featured_images_size_vcel('large', $penci_featimg_size, $thumb_bigsize ) ); ?>" href="<?php penci_permalink_fix(); ?>" title="<?php echo wp_strip_all_tags(
						get_the_title() ); ?>">
					</a>
				<?php } else { ?>
					<a class="penci-image-holder<?php echo penci_class_lightbox_enable(); ?>" style="background-image: url('<?php echo penci_get_featured_image_size( get_the_ID(), penci_featured_images_size_vcel('large' , $penci_featimg_size, $thumb_bigsize ) ); ?>');" href="<?php penci_permalink_fix(); ?>"
					   title="<?php echo
