...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if( 'yes' != $atts['standard_thumbnail'] ): ?>
		...
		<?php if ( penci_get_post_format( 'link' ) || penci_get_post_format( 'quote' ) ) : ?>
			<div class="standard-post-image standard-post-special<?php if ( penci_get_post_format( 'quote' ) ): ?> penci-special-format-quote<?php endif; ?><?php if ( ! has_post_thumbnail() || 'yes' == $atts['standard_thumbnail'] ) : echo ' no-thumbnail'; endif; ?>">
				<?php if ( has_post_thumbnail() && 'yes' != $atts['standard_thumbnail'] ) : ?>
					<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
						<a <?php if( 'yes' == $standard_thumb_crop ): ?> class="penci-image-holder penci-lazy" data-src="<?php echo penci_get_featured_image_size( get_the_ID(), 'penci-full-thumb' ); ?>"<?php endif; ?> href="<?php the_permalink() ?>">
							<?php if( 'yes' != $standard_thumb_crop ): ?><img class="attachment-penci-full-thumb size-penci-full-thumb penci-lazy wp-post-image" src="<?php echo get_template_directory_uri() . '/images/penci-holder.png'; ?>" alt="<?php echo $thumb_alt; ?>"<?php echo $thumb_title_html; ?> data-src="<?php echo penci_get_featured_image_size( get_the_ID(), 'penci-full-thumb' ); ?>"><?php endif; ?>
						</a>
					<?php } else { ?>
	...
	<div class="header-standard<?php if( 'yes' == $atts['standard_meta_overlay'] ): echo ' standard-overlay-meta'; endif; ?>">
		...
		<?php if ( 'yes' != $standard_author || penci_isshow_reading_time( $standard_readtime ) ) : ?>
...
if( isset( $infeed_ads ) && $infeed_ads ){
	penci_get_markup_infeed_ad(
		array(
			'wrapper' => 'article',
			'classes'      => 'post penci-infeed-data penci-infeed-vcele',
