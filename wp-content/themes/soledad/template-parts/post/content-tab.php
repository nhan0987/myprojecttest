    ...
    <div class="grid grid-cols-10 md:grid-cols-1 pt-2 pb-2 md:p-2">
            
            <?php if (has_post_thumbnail()) { ?>
                <div class="content-image col-span-4 md:col-span-1 pr-2 md:pr-0">
            ...
            ?>
                <div class="content-image col-span-4 md:col-span-1 pr-2 md:pr-0 md:h-[150px]">
            ...
            ?>
            <div class="content-box col-span-6 md:col-span-1">
