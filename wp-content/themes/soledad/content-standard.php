...
<article id="post-<?php the_ID(); ?>" <?php post_class("item"); ?>>
	<div class="flex flex-nowrap gap-2! xl:gap-4!">
		...
		<?php if( ! get_theme_mod( 'penci_standard_thumbnail' ) ): ?>
			...
			<?php else : ?>
				<div class="standard-post-image content-image cut-the-top-left-corner-23-container">
					<?php if ( has_post_thumbnail() ) { ?>
						
							<?php if( ! get_theme_mod( 'penci_disable_lazyload_layout' ) ) { ?>
								<a <?php if( get_theme_mod( 'penci_standard_thumb_crop' ) ): ?> class="penci-image-holder penci-lazy" <?php endif; ?> href="<?php the_permalink() ?>">
									<?php if( ! get_theme_mod( 'penci_standard_thumb_crop' ) ): ?><img class="w-full! h-full! object-cover zoom-image" src="<?php echo penci_get_featured_image_size( get_the_ID(), 'penci-full-thumb' ); ?>" alt="<?php echo $thumb_alt; ?>"<?php echo $thumb_title_html; ?> ><?php endif; ?>
								</a>
					...
					?>
							...
							<a  href="<?php the_permalink() ?>">
								<img class="w-full! h-full! object-cover zoom-image" src="<?php echo $default_thumbnail_src; ?>" alt="default">
							</a>
							<div class="content-days right-0 bottom-0 absolute bg-white">
								<?php the_time('d/m/Y '); ?>
							</div>
		...
		<div class="header-standard content-box<?php if( get_theme_mod('penci_standard_meta_overlay') ): echo ' standard-overlay-meta'; endif; ?>">
			<?php if ( ! get_theme_mod( 'penci_standard_cat' ) ) : ?>
				<div class="penci-standard-cat"><span class="cat"><?php penci_category( '' ); ?></span></div>
			<?php endif; ?>
			
			<h3 class="content-name"><a href="<?php the_permalink(); ?>"><p><?php the_title(); ?></p></a></h3>
			...
			if ( ! get_theme_mod( 'penci_standard_author' ) || penci_isshow_reading_time( $hide_readtime ) ) : ?>
				<div class="penci-meta-author standard-top-meta author-post byline hidden">
					...
					<span class="penci-readtime hidden"><?php penci_reading_time(); ?></span>
					<?php endif; ?>
				</div>
			<?php endif; ?>
		</div>

		<div class="standard-content hidden">
