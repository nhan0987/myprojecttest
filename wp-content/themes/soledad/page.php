...
<?php if ( ! get_theme_mod( 'penci_disable_breadcrumb' ) && ( 'no' != $breadcrumb ) ): ?>
	...
	if ( function_exists( 'yoast_breadcrumb' ) ) {
		$yoast_breadcrumb = yoast_breadcrumb( '<div class="max-w-sm xl:max-w-7xl mx-auto px-4 lg:px-0! container-single-page penci-breadcrumb ' . $class_small_width . '">', '</div>', false );
	}

	if( $yoast_breadcrumb ){
		echo $yoast_breadcrumb;
	}else{ ?>
	<div class="max-w-sm xl:max-w-7xl mx-auto px-4 lg:px-0! container-single-page penci-breadcrumb<?php echo $class_small_width; ?>">
