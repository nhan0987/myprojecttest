...
<?php } else {
	...
	?>
	<div class="penci-page-header penci-page-header-category max-w-[23rem]! xl:max-w-[114rem]! mx-auto justify-center items-center flex flex-col" <?php echo $header_style; ?>>
		<h1 class="entry-title"><?php printf( esc_html__( '%s', 'soledad' ), single_cat_title( '', false ) ); ?></h1>
