...
if (!function_exists('lth_title_output_fe')) :
    ...
    $color_title = isset($attributes['color_title']) ? 'color: ' . $attributes['color_title'] : '';
    $color_description = isset($attributes['color_description']) ? 'color: ' . $attributes['color_description'] : '';
?>
