...
if ( function_exists( 'lazyblocks' ) ) :
   ...
   $block_fields = array(
      'id'           => 'lth_slider', //thay đổi
      'title'        => 'LTH: Slider', //thay đổi
      ...
      'slug'         => 'lazyblock/lth-slider', //thay đổi
      'category'     => 'common'
   );
   ...
   lazyblocks()->add_block( array(
      ...
      'controls' => array(
         ...
         'control_image_lth_item_image_mobile' => array(
            'type' => 'image',
            'name' => 'item_image_mobile',
            'default' => '',
            'label' => 'Image Mobile',
            'help' => 'Ảnh hiển thị trên màn hình mobile',
            'child_of' => 'control_repeater_lth_items',
            'placement' => 'inspector',
            'width' => '100',
            'hide_if_not_selected' => 'false',
         ...
         'control_textarea_lth_item_text_top' => array(
            'type' => 'textarea',
            'name' => 'text_top',
            'default' => '',
            'label' => 'Text Top',
         ...
         'control_textarea_lth_item_text_title' => array(
            'type' => 'textarea',
            'name' => 'text_title',
            'default' => '',
            'label' => 'Text Title',
         ...
         'control_textarea_lth_item_text_bottom' => array(
            'type' => 'textarea',
            'name' => 'text_bottom',
            'default' => '',
            'label' => 'Text Bottom',
