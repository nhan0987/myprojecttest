		...
		public function install_plugins_page() {
			...
			<div class="tgmpa wrap">
				...
				<div class="penci-plugins-notice">
					...
					<p class="penci-dplugins"><span class="penci-notice-head">Penci Speed Optimizer:</span> <?php _e( 'It is a plugin to help you can optimize scores and speed on Google Page Speed, GTMetrix, Pingdom, Yslow.. You need to activate the theme & plugin <strong>Penci Shortcodes & Performance</strong> together with this plugin to get it works.', 'tgmpa' ); ?></p>
					...
					<p class="penci-dplugins"><span class="penci-notice-head">Penci Slider:</span> <?php esc_html_e( 'A plugin to help you build a custom slider does not based on Posts when you use Customize to config the homepage. If you are using Elementor or WPBakery - you do not need to use this plugin.', 'tgmpa' ); ?></p>
					<p class="penci-dplugins"><span class="penci-notice-head">Penci Recipe:</span> <?php esc_html_e( 'A plugin to help you can create Food Recipes.', 'tgmpa' ); ?></p>
					<p class="penci-dplugins"><span class="penci-notice-head">Penci Review:</span> <?php esc_html_e( 'A plugin to help you can create reviews for your posts.', 'tgmpa' ); ?></p>
					<p class="penci-dplugins"><span class="penci-notice-head">Penci Soledad Demo Importer:</span> <?php esc_html_e( 'A plugin to help you can import any demo from our demos. After the installed demo, you can deactivate & delete it if you want.', 'tgmpa' ); ?></p>
					<p class="penci-dplugins"><span class="penci-notice-head">oAuth Twitter Feed:</span> <?php esc_html_e( 'A plugin to help you connect to Twitter Apps and help you show the tweets via widget "Soledad Tweet Slider"', 'tgmpa' ); ?></p>
