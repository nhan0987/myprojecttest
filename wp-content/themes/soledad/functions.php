...
function penci_dequeue_soledad_for_landing() {
	if (is_page_template('template-hinode-park.php') || is_page_template('template-noble-palace.php') || is_page_template('template-jade-lake.php') || is_page_template('template-simona-heights.php')) {
