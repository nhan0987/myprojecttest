 ...
 */
	...
	function inject_footer_custom_js() {
		...
		if ( is_category('nha-mat-pho') || is_category('biet-thu-lien-ke')|| is_category('toa-nha-van-phong')|| is_category('khach-san-can-ho-dich-vu')|| is_category('chung-cu-cao-cap')) { 
